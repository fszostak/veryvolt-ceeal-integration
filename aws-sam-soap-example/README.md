...
```bash
aws-sam-soap-example$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
aws-sam-soap-example$ sam logs -n HelloWorldFunction --stack-name aws-sam-soap-example --tail
```
...
```bash
aws-sam-soap-example$ cd hello-world
